...
window.BMAP_AUTHENTIC_KEY = "BCn6LmyafS727RVvnei8vx1xK06iUGxS"; (function () {
    function ba(a) {
        throw a;
    }
    var j = void 0,
    ...
    function Ka(a, b) {
        if (a = x.$(a)) {
            ...
            c.K.ue && (this.eY(c.K.ue.controls), this.$L(c.K.ue.geotableId));
    ...
    x.extend(Ka.prototype, {
        ...
        hk: function (a, b, c, d) {
			...
			f = this.xe,
			g = o;
            c && H.eM(c) && (this.gf = new H(c.lng, c.lat), g = q);
            if (c = c && d ? f.Nm(c, this.Xb) : this.mc) if (this.mc = new H(c.lng + a * e, c.lat - b * e), (a = f.oh(this.mc, this.Xb)) && g) this.gf = a
        },
        Dg: function (a, b) {
            if (Wa(a) && (this.Vu(), this.dispatchEvent(new M("onzoomstart")), a = this.Yn(a).zoom, a !== this.Oa)) {
                this.Lc = this.Oa;
                this.Oa = a;
                var c;
        ...
        ui: function (a) {
            a instanceof H && (this.mc = this.xe.Nm(a, this.Xb), this.gf = H.eM(a) ? new H(a.lng, a.lat) : this.xe.oh(this.mc, this.Xb))
        },
        xg: function (a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        qw: function (a) {
            a && Xa(a.Ee) && (a.Ee(this), this.dispatchEvent(new M("onaddcontrol", a)))
        },
        BN: function (a) {
        ...
        Ka: function (a) {
            a && Xa(a.Ee) && (a.Ee(this), this.dispatchEvent(new M("onaddoverlay", a)))
        },
        Ub: function (a) {
        ...
        Wf: function (a) {
            ...
            if (a instanceof H) b.ui(a, {
                ...
                var d = this.JH();
                d.wF(function (c) {
                    0 === d.ym() && 2 === d.Fa.result.type && (b.Wf(c.xk(0).point), Pa.tk(a) && b.qF(a))
                });
                d.search(a, {
                    log: "center"
                })
        ...
        disableAutoResize: function () {
            this.K.Js = q;
            this.R.Yl && (clearInterval(this.R.Yl), this.R.Yl = p)
        },
        Qo: function () {
            this.K.Qo = o;
        ...
        gW: function () {
            this.K.Qo = q;
            this.Nn && (this.xh(this.Nn), this.Nn = p, delete this.Nn)
        },
        Bb: function () {
        ...
        ct: function (a, b) {
            ...
            for (var b = b || {},
			e = [], f = 0, g = d.length; f < g; f++) e.push(this.xe.Nm(d[f], this.Xb));
            d = new db;
        ...
        Tt: function (a) {
            ...
            if (a) {
				...
				50) : (this.K.ue = a, this.dispatchEvent(new M("onsetcustomstyles", a)), this.$L(b.K.ue.geotableId));
                var c = {
                    style: a.style
                };
		    ...
		    if (!B || !B.Lo) {
				...
				P = function (a) {
				    ...
				    if ("define" == a || "require" == a) {
				        ...
				        c = !c ? "#" + D++ : c;
				        d = Z[c] = Z[c] || {};
				        d.Lo || (d.name = c, d.tZ = e, d.wK = f, "define" == a && (d.$V = o), g(d))
    ...
    x.object.extend(I, {
        ...
        yN: function (a) {
            for (var b = 0; b < this.Pd.Hn.length; b++) if (this.Pd.Hn[b] == a) return;
            this.Pd.Hn.push(a)
        },
        zZ: function (a, b) {
            var c = this.ib(a);
        ...
        fK: function (a, b) {
            ...
            c.timeout = setTimeout(function () {
                c.Pd.tl[a].Bd != c.Fj.dq ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
            },
			c.iG.zU)
        },
        ib: function (a) {
            this.Pd.tl[a] || (this.Pd.tl[a] = {},
			this.Pd.tl[a].Bd = this.Fj.pG, this.Pd.tl[a].Ru = []);
            return this.Pd.tl[a]
        },
        remove: function (a) {
            delete this.ib(a)
    ...
    x.object.extend(Xb.prototype, {
        ...
        rw: function (a) {
            if (a && Wa(a.id) && !isNaN(a.id)) {
				...
				c;
                for (c in a) b[c] = a[c];
                if (a = this.rm(a.id)) for (var d in b) a[d] = b[d];
                else this.dc.push(b)
            }
        },
        rm: function (a) {
    ...
    function db(a, b) {
        ...
        a && (this.Nl = new H(a.lng, a.lat), this.wl = new H(b.lng, b.lat), this.Le = a.lng, this.Ke = a.lat, this.Ge = b.lng, this.Fe = b.lat)
    }
    x.object.extend(db.prototype, {
        ...
        extend: function (a) {
            if (a instanceof H) {
                ...
                if (!this.Le || this.Le > b) this.Nl.lng = this.Le = b;
                if (!this.Ge || this.Ge < b) this.wl.lng = this.Ge = b;
                if (!this.Ke || this.Ke > a) this.Nl.lat = this.Ke = a;
                if (!this.Fe || this.Fe < a) this.wl.lat = this.Fe = a
            }
        },
        LF: function () {
    ...
    eb.prototype.Ob = function (a) {
        this.map && (this.map.Wc(), a.Qa = o, this.map.R.nl = a, a.ab = this, x.lang.Ca.call(a, a.ba))
    };
    eb.prototype.Wc = function () {
        this.map && this.map.R.nl && (this.map.R.nl.Qa = q, x.lang.Vw(this.map.R.nl.ba), this.map.R.nl = p)
    };
    function tc(a, b) {
        eb.call(this);
        this.content = a;
    ...
    function yc(a, b) {
		...
		this.iB = [], this.le = [], I.load("pointcollection",
		function () {
		    for (var a = 0,
    ...
    x.extend(Bc.prototype, {
        ...
        kn: function (a, b) {
            this.uo[a] && (this.uo[a] = new H(b.lng, b.lat), this.ia[a] = new H(b.lng, b.lat), 0 == a && !this.ia[0].nb(this.ia[this.ia.length - 1]) && (this.ia[this.ia.length - 1] = new H(b.lng, b.lat)), this.Eh())
        },
        qe: function () {
            var a = this.uo;
    ...
    x.extend(Fc.prototype, {
        ...
        Bm: function (a, b, c) {
			...
			w.kr = q,
			this.Me.push(w);
            if (l = this.Um) for (var A in l) delete l[A];
            else this.Um = {};
			...
			m = this.Um[y],
			n = p,
			m ? (n = m.style, n.left = t + "px", n.top = v + "px", m.Ze || this.tn.push([A, i, m])) : (0 < this.Ne.length ? (m = this.Ne.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.Px() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = t + "px", n.top = v + "px", -1 < y.indexOf("bg") && (t = "#F3F1EC", this.map.K.Do && (t = this.map.K.Do), n.background = t ? t : ""), this.tn.push([A, i, m])),
			m.style.visibility = "";
            l = 0;
        ...
        m_: function (a, b, c, d) {
            ...
            k && k.Ib ? (ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.yf() : Jc(k,
			function () {
			    e.yf()
			})) : (k = this.dj[g]) && k.Ib ? (c.Rb.insertBefore(k.Ib, c.Rb.lastChild), this.vg[g] = k, ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.yf() : Jc(k,
			function () {
			    e.yf()
			})) : (k = i * Math.pow(2, f.um() - a[2]), new H(a[0] * k, a[1] * k), d = new R(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new Kc(this, d, b, a, c), Jc(k,
			function () {
			    e.yf()
			}), k.co(), this.vg[g] = k)
        },
        ...
        Hx: function (a) {
            ...
            delete this.vg[a.name];
            a.loaded || (Lc(b), Hc(a), a.Ib = p, a.Rm = p)
        },
        Bw: function (a, b) {
            for (var c = 0,
        ...
        Tt: function (a) {
			...
			c = "2" == z.Qy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Om[d]; d++) if (e.h_ == o) {
			    b.k.$b = 18;
    ...
    x.extend(Gc.prototype, {
        ...
        getTilesUrl: function (a, b) {
            if (this.map.pa() !== Ya && this.map.pa() !== Sa) var c = this.map.cb.Bw(a.x, b).es;
            var d = "";
    ...
    Yc.getTilesUrl = function (a, b, c) {
        ...
        e = 1,
        z = b;
        //return "../view/map/tiles/" + z + "/" + x + "/" + y + ".png";
    ...
    function Na(a, b) {
        function c() {
            e.k.visible ? ("inter" === e.Ie && e.k.haveBreakId && e.k.indoorExitControl === o ? x.D.show(e.wA) : x.D.U(e.wA), this.k.closeControl && this.zf && this.C && this.C.La() === this.B ? x.D.show(e.zf) : x.D.U(e.zf), this.k.forceCloseControl && x.D.show(e.zf)) : (x.D.U(e.zf), x.D.U(e.wA))
        }
        ...
        this.k.OS !== o && (this.co(), z.Fn("cus.fire", "count", "z_loadpanoramacount"));
        this.ET(this.B);
    ...
    x.extend(Na.prototype, {
        ...
        at: u("Ie"),
        By: function (a) {
            a !== this.Ie && (this.Ie = a, this.dispatchEvent(new M("onscene_type_changed")))
        },
        rc: function (a, b, c) {
            "object" === typeof b && (c = b, b = j);
            a != this.Ya && (this.ql = this.Ya, this.rl = this.Mb, this.Ya = a, this.Ie = b || "street", this.Mb = p, c && c.pov && this.Mc(c.pov))
        },
        ta: function (a) {
            a.nb(this.Mb) || (this.ql = this.Ya, this.rl = this.Mb, this.Mb = a, this.Ya = p)
        },
        Mc: function (a) {
    ...
    x.extend(Qd.prototype, {
        ...
        Xn: function () {
            var a = 0,
			b, c;
            this.P && (b = this.P.ha(), (c = this.ha()) && !c.nb(b) && (a = S.Zo(b, c)));
            return a
        },
        U: function () {
            ba("hide\u65b9\u6cd5\u672a\u5b9e\u73b0")
    ...
    function Ma(a) {
        ...
        if (a === q || !window.WebGLRenderingContext || x.platform.Km && -1 == navigator.userAgent.indexOf("Android 5")) return Vd = q;
        var a = document.createElement("canvas"),
		b = p;
        try {
    ...
    x.extend(bc.prototype, {
        ca: function () {
			...
			function () {
			    c.Qg(bc.bl + "qt=idata&iid=" + b.sA + "&fn=",
				function (b) {
    ...
    Me.prototype = {
        ...
        Cr: function (a, b) {
            this.Xk || (a = this.lp ? a : 0, b = this.xn ? b : 0, this.options.Uk ? this.Pb.style[le] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + Le : (a = ce.round(a), b = ce.round(b), this.Pb.style.left = a + "px", this.Pb.style.top = b + "px"), this.x = a, this.y = b, this.qB("h"), this.qB("v"))
        },
        qB: function (a, b) {
        ...
        Rv: function (a) {
            ...
            if (this.enabled) {
                ...
                if (this.options.Yx && (this.options.Uk ? (c = getComputedStyle(this.Pb, p)[le].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Pb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Pb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Ai ? this.Wd(Ie) : Ke(this.WB),
				this.Aj = [],
				this.Cr(d, c),
        ...
        cT: function (a) {
			...
			this.options.nN && this.options.nN.call(this, a);
                ...
                this.th = b.pageX;
                this.uh = b.pageY;
                if (0 < e || e < this.fe) e = this.options.Fo ? this.x + c / 2 : 0 <= e || 0 <= this.fe ? 0 : this.fe;
                if (f > this.rf || f < this.nd) f = this.options.Fo ? this.y + d / 2 : f >= this.rf || 0 <= this.nd ? this.rf : this.nd;
                this.NC += c;
                this.OC += d;
            ...
            if (!(Ae && 0 !== a.touches.length)) {
				...
				b.options.Ap && b.options.Ap.call(b, a);
                    ...
                    if (b.ph) {
                        ...
                        f.Ba || g.Ba ? (c = ce.max(ce.max(f.time, g.time), 10), b.options.du && (f = d - b.lw, g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ? b.scrollTo(b.lw, b.mw, 200) : (f = b.hJ(d, e), d = f.x, e = f.y, c = ce.max(f.time, c))), b.scrollTo(ce.round(d), ce.round(e), c)) : b.options.du ? (f = d - b.lw, g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ? b.scrollTo(b.lw, b.mw, 200) : (f = b.hJ(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.lo(200)
                    } else {
        ...
        GU: function (a) {
            ...
            if ("zoom" == b.options.VO) {
                if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Wk && (d = b.options.Wk), d > b.options.bq && (d = b.options.bq), d != b.scale) !b.Sy && b.options.Bp && b.options.Bp.call(b, a),
				b.Sy++,
        ...
        CU: function (a) {
            a.target == this.Pb && (this.Wd(Ie), this.CB())
        },
        CB: function () {
            var a = this,
			b = a.x,
			...
			f,
			g;
            a.Xl || (a.Aj.length ? (e = a.Aj.shift(), e.x == b && e.y == c && (e.time = 0), a.Xl = o, a.ph = o, a.options.Ai) ? (a.qJ(e.time), a.Cr(e.x, e.y), a.Xl = q, e.time ? a.ca(Ie) : a.lo(0)) : (g = function () {
                var i = Date.now(),
				k;
                if (i >= d + e.time) {
                    a.Cr(e.x, e.y);
        ...
        refresh: function () {
            ...
            this.Iv("h");
            this.Iv("v");
            this.Xk || (this.Pb.style[oe] = "0", this.lo(400))
        },
        ...
        zoom: function (a, b, c, d) {
            var e = c / this.scale;
            this.options.Uk && (this.Xk = o, d = d === j ? 200 : d, a = a - this.VF - this.x, b = b - this.WF - this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.fe ? this.fe : this.x, this.y = this.y > this.rf ? this.rf : this.y < this.nd ? this.nd : this.y, this.Pb.style[oe] = d + "ms", this.Pb.style[le] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Le, this.Xk = q)
        }
    };
    function ke(a) {
        if ("" === ee) return a;
